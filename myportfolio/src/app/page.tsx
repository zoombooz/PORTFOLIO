        ...
        <div className=" h-full relative">
            ...
            <div className="flex bg-gray-700 h-screen text-center items-center justify-center px-32 ">
                ...
                <div className="w-1/2 h-full flex justify-center items-center">
                    <img src="https://images.unsplash.com/photo-1573865526739-10659fec78a5?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8Y2F0fGVufDB8fDB8fHww" alt="My Self" className="rounded-full h-96 w-96" />
                </div>
            </div>
